...
class CmcScraper(object):
    ...
    def __init__(
        ...
        """
        :param currency: money currency e.g. USD
    ...
    def __repr__(self):
        return (
            "<CmcScraper currency:{}, coin_code:{}, start_date:{}, end_date:{}, all_time:{}>".format(
                self.currency, self.coin_code, self.start_date, self.end_date, self.all_time
            )
        )
    ...
    def _download_data(self, **kwargs):
        ...
        coin_data = download_coin_data(self.currency, self.coin_code, self.start_date, self.end_date)
